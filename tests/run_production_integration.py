...
def run_production_tests():
    ...
    try:
        ...
        result = subprocess.run([
            ...
            '--json-report-file=production_test_report.json'
        ...
        report_file = os.path.join(os.path.dirname(__file__), 'production_test_report.json')
        if os.path.exists(report_file):
            try:
                ...
                if summary.get('total', 0) > 0:
                    success_rate = (summary.get('passed', 0) / summary.get('total', 0)) * 100
                ...
                if summary.get('failed', 0) == 0 and summary.get('error', 0) == 0:
                    ...
                    return False, f"{summary.get('failed', 0)} tests failed, {summary.get('error', 0)} errors"
